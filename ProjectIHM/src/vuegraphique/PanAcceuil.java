...
public class PanAcceuil extends JPanel  {
	private static final long serialVersionUID = 4721795520307721056L;
		...
		public void initialisation() {
					...
					JtexteAccueil.setFont(new Font("Robotic", Font.BOLD, 60));
					
					//TEXTE NOTIFICATIONS
					JTexteNotificcation.setText("Notifications :                                           ");
					JTexteNotificcation.setFont(new Font("Robotic", Font.BOLD, 20));
							    	...
							    	if(notif==3) {
								    	...
								    	if(notif==4) {
									    	...
									    	if(notif==5) {
									    		...
									    		JTexteNotificcation.setFont(new Font("Robotic", Font.ITALIC, 20));
									    		JTexteNotificcation.setText("No more notification                                  ");
									    		JNotificcation.setVisible(false);
					...
					boxgauche.add(Box.createRigidArea(new Dimension(0,10)));
					...
					boxgauche.setBounds(-250,-30,1000,1000);
					boxdroite.setBounds(500,-250,1000,1000);
					this.add(boxgauche);
					this.add(boxdroite);
