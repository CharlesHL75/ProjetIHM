		...
		boxcamerabig6.setVisible(false);
		       ...
		       //camera 1
			    BufferedImage camera1=null;
		     	try {
				camera1 = ImageIO.read(new File("RESSOURCE/camera1.png"));
				...
				try {
					camerabig1 = ImageIO.read(new File("RESSOURCE/camerabig1.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camera2 = ImageIO.read(new File("RESSOURCE/camera2.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camerabig2 = ImageIO.read(new File("RESSOURCE/camerabig2.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camera3 = ImageIO.read(new File("RESSOURCE/camera3.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camerabig3 = ImageIO.read(new File("RESSOURCE/camerabig3.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camera4 = ImageIO.read(new File("RESSOURCE/camera4.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camerabig4 = ImageIO.read(new File("RESSOURCE/camerabig4.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camera5 = ImageIO.read(new File("RESSOURCE/camera5.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camerabig5 = ImageIO.read(new File("RESSOURCE/camerabig5.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camera6 = ImageIO.read(new File("RESSOURCE/camera6.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
				...
				try {
					camerabig6 = ImageIO.read(new File("RESSOURCE/camerabig6.png"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}		
